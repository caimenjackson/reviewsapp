<x-layout>
    ...
    <div class="flex w-full mx-auto mt-5" style="padding-left: 2%; padding-right: 2%;">
        ...
        <div class="w-4/5">
            <h1 class="text-center mb-4 text-black">Top 5 Categories with Highest Average Ratings</h1>
            <table class="w-full text-left table-auto shadow-lg bg-white">
                ...
                <tbody>
                    @foreach ($topCategories as $category)
                        <tr class="text-black">
                            <td class="border px-4 py-2">{{ $category->categories }}</td>
                            <td class="border px-4 py-2">{{ number_format($category->average_rating, 2) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
