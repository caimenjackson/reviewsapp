@if(!request()->cookie('cookie_consent'))
    <div class="cookie-popup-container bg-yellow-500" style="position: fixed; bottom: 20px; left: 50%; transform: translateX(-50%); width: 80%; max-width: 2000px; min-height: 20%; z-index: 9999; border: 1px solid #ccc; border-radius: 8px; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
